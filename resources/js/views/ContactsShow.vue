    ...
    <div>
        ...
        <div v-else>
            ...
            <div class="flex justify-between">
                ...
                <div class="relative">
                    <router-link :to="/contacts/ + contact.contact_id +'/edit'" class="px-4 py-2 rounded text-sm text-green-500 font-bold border mr-2 border-gray-500">Edit</router-link>
                    <a href="#" class="px-4 py-2 border border-red-500 rounded font-bold text-sm text-red-500" @click="modal = ! modal">Delete</a>
            ...
            <p class="text-gray-600 font-bold uppercase  pt-2 text-sm">Contact</p>
            <p class="pt-2 text-blue-400">{{contact.email}}</p>
            <p class="text-gray-600 font-bold uppercase text-sm pt-2">Company</p>
            <p class="pt-2 text-blue-400">{{contact.company}}</p>
            <p class="text-gray-600 font-bold uppercase text-sm pt-2">Birthday</p>
