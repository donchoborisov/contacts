 ...
 <div class="flex">
     ...
     <div class=" pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
        <nav class="pt-4">
            ...
            <p class="text-gray-500 pt-12 uppercase font-bold text-xs ">Create</p>
            ...
            <p class="text-gray-500 pt-12 uppercase font-bold text-xs ">General</p>
            ...
            <p class="text-gray-500 pt-12 uppercase font-bold text-xs ">Settings</p>
            <router-link class="flex items-center py-2 hover:text-blue-600 text-sm"to="/">
