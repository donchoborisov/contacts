...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300 ">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        <svg class="fill-current text-gray-200 w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div class="col-md-6">
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700" name="email"  placeholder="your@email.com">
            ...
            <div class="pt-8 ">
                <button type="submit" class=" w-full py-2 px-3  text-left uppercase rounded text-blue-800 font-bold bg-gray-400 ">
                    Login
                </button>
            </div>
