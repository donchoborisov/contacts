         ...
         <h2 class="text-base text-blue-300">Enter your information below</h2>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" type="text" class="w-full p-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100" name="name" placeholder="Your Name">
                        ...
                        <div class="relative pt-3">
                            ...
                            <input id="email" type="email" class="w-full p-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100"  name="email" placeholder="your@email.com">
                        ...
                        <div class="relative pt-3">
                            ...
                            <input id="password" type="password" class="w-full p-3 pt-8 rounded focus:outline-none focus:bg-blue-700 bg-blue-800 text-gray-100 " name="password"  placeholder="Password">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="pt-6">
                                <button type="submit" class="w-full py-2 px-3 bg-gray-400 rounded text-left text-blue-800 text-gray-100 uppercase font-bold">
                                    Register
                                </button>
                            </div>
