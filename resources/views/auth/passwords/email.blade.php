...
@section('content')
<div class="bg-gray-300 h-full mx-auto flex justify-center items-center">
    <div class="w-96 p-6 rounded-lg shadow-xl bg-blue-900">
        ...
        <h2 class="text-base pb-4 text-blue-300">Enter your email to reset your password</h2>

        <form method="POST" action="{{ route('password.email') }}">
                        @csrf

                        <div class="relative">
                            <label for="email" class="text-blue-500 text-xs absolute uppercase font-bold pl-3 pt-2 ">Email</label>
                            ...
                            <div class="pt-6">
                                <button type="submit" class="bg-gray-400 w-full text-left py-2 px-3 rounded uppercase text-blue-800 text-gray-100 font-bold">
                                   Send reset email
                                </button>
